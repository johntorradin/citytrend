...
<head>
	...
	<link href="css/content_item.css" rel="stylesheet" type="text/css">
	<link href="css/slider.css" rel="stylesheet" type="text/css">
	<link href="css/footer.css" rel="stylesheet" type="text/css">
	<title>CityTrend - Страница товара</title>
...
<body>
	<div class="container">
		<?php 
			...
			require 'includes/content_item.php';
...
<script>
	...
	$(document).ready(function() {
		...
		$(window).scroll(function() {
			other.toTopToggle();
			item.reviewsCountSelect();
			item.startReviewsSelect('новые');
			iselect.mainWatchedItems();
			item.similarItemsSelect();
		});
